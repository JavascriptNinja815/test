...
mage::log(__METHOD__ . __LINE__ . " BREAKING " .  get_class($this), null, 'ch_Shippingmess.log');
        $includeComment = false;
}
...
mage::log(__METHOD__ . __LINE__ . " sending " , null, 'ch_Shippingmess.log');
        ...
        if (CH_SEND_EMAIL && $notifyCustomer) {
