 ...
 */
class TinyBrick_OrderArchive_Block_Adminhtml_Orderarchive_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	public function __construct()
	{
		parent::__construct();
		$this->setId('orderarchiveGrid');
    ...
    protected function _prepareCollection()
    {
        ...
        ->joinLeft(array('orderarchive_tbl'=>Mage::getSingleton('core/resource')->getTableName('orderarchive')),
        		...
        		'order_group_id')
        		->where('orderarchive_tbl.`order_group_id`=1');
    ...
    protected function _prepareMassaction()
    {
		...
		$this->getMassactionBlock()->addItem('archive_order', array(
				'label'=> Mage::helper('sales')->__('Un-Archive Order(s)'),
				'url'  => $this->getUrl('orderarchive/adminhtml_orderarchive/unarchiveorder'),
		));
