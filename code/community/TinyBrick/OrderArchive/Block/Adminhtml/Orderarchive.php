 ...
 */
class TinyBrick_OrderArchive_Block_Adminhtml_Orderarchive extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_orderarchive';
        $this->_blockGroup = 'orderarchive';
        $this->_headerText = Mage::helper('orderarchive')->__('Archived Orders');
        parent::__construct();
