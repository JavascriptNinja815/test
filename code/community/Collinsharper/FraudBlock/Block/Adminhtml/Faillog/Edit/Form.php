 ...
 *
 */
class Collinsharper_Fraudblock_Block_Adminhtml_Faillog_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        */
        ...
        $fieldset = $form->addFieldset('fraudblock_form', array('legend'=>Mage::helper('fraudblock')->__('information')));
