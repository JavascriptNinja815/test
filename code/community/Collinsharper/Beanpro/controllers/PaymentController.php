...
class Collinsharper_Beanpro_PaymentController extends Mage_Core_Controller_Front_Action
{
	...
	public function redirectAction()
    {
		...
		$order = Mage::getModel('sales/order')->load($orderId);
		   ...
		   $order->setState(
		   Collinsharper_Beanpro_Model_PaymentMethod::PENDINGVBV, Collinsharper_Beanpro_Model_PaymentMethod::PENDINGVBV,
    ...
    public function returnAction()
    {
		...
		if($return['trnApproved'] == 1)
		{
			...
			if(Mage::getStoreConfig('payment/beanpro/payment_action') == Mage_Paygate_Model_Authorizenet::ACTION_AUTHORIZE_CAPTURE)
			{
