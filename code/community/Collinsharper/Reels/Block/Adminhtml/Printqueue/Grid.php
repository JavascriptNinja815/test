<?php
/**
 * Collinsharper/Reels/Block/Adminhtml/Printqueue/Grid.php
 *
 * PHP version 5
 *
 ...
 */
/**
 * Collinsharper_Reels_Block_Adminhtml_Printqueue_Grid
 *
 * PHP version 5
 *
 * @category  Collinsharper
 ...
 *
 */
class Collinsharper_Reels_Block_Adminhtml_Printqueue_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('printqueueGrid');
 ...
 */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('final_reel_filename', array(
            'header'    => Mage::helper('chreels')->__('Reel Filename'),
            'align'     =>'left',
    ...
    {
        $this->setMassactionIdField('Printqueue_id');
        $this->getMassactionBlock()->setFormFieldName('Printqueue');
