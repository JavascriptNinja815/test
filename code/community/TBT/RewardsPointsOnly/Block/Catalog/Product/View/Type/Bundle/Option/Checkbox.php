...
/**
 * Frontend Bundle Option Checkbox Type Renderer for PointsOnly Price
 *
 * @category   TBT
 * @package    TBT_RewardsPointsOnly
 * @author     Sweet Tooth Inc. <support@sweettoothrewards.com>
 */
class TBT_RewardsPointsOnly_Block_Catalog_Product_View_Type_Bundle_Option_Checkbox
