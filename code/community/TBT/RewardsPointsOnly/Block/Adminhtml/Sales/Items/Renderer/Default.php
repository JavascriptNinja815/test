...
/**
 * Adminhtml Invoice Item PointsOnly Renderer
 *
 * @category   TBT
 * @package    TBT_RewardsPointsOnly
 * @author     Sweet Tooth Inc. <support@sweettoothrewards.com>
 */
class TBT_RewardsPointsOnly_Block_Adminhtml_Sales_Items_Renderer_Default
    extends Mage_Adminhtml_Block_Sales_Items_Renderer_Default
{
    ...
    private function _getItemPointsCost()
    {
        ...
        return Mage::getSingleton('rewardspointsonly/service_processRules')
            ->getItemPointsCost($item, $itemQtyOrdered);
    }
}
