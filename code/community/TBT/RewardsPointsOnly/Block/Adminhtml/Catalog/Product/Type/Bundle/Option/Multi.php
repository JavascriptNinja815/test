...
/**
 * Adminhtml Bundle Option Multi Type Renderer for PointsOnly Price
 *
 * @category   TBT
 * @package    TBT_RewardsPointsOnly
 * @author     Sweet Tooth Inc. <support@sweettoothrewards.com>
 */
class TBT_RewardsPointsOnly_Block_Adminhtml_Catalog_Product_Type_Bundle_Option_Multi
    extends Mage_Bundle_Block_Adminhtml_Catalog_Product_Composite_Fieldset_Options_Type_Multi
{
    /**
