...
/**
 * Adminhtml Price renderer for PointsOnly
 *
 * @category   TBT
 * @package    TBT_RewardsPointsOnly
 * @author     Sweet Tooth Inc. <support@sweettoothrewards.com>
 */
class TBT_RewardsPointsOnly_Block_Adminhtml_Catalog_Product_Price
    extends Mage_Adminhtml_Block_Catalog_Product_Price
{
    /**
