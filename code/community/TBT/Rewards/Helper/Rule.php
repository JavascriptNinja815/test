...
class TBT_Rewards_Helper_Rule extends Mage_Core_Helper_Abstract
{
     ...
     * @param TBT_Rewards_Model_Salesrule_Rule|Mage_SalesRule_Model_Rule $rule
     */
    public function isPointsRule($rule)
    {
        if ($rule instanceof TBT_Rewards_Model_Salesrule_Rule) {
        ...
        Mage::logException ( new Exception ( "Reached Helper_Rule::isPointsRule() with parameter that is not a cart rule." ) );
