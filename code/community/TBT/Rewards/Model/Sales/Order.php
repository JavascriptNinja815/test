...
class TBT_Rewards_Model_Sales_Order extends Mage_Sales_Model_Order
{
    ...
    {
        return array_sum($this->getTotalSpentPoints()) > 0;
    }
    ...
    {
        return array_sum($this->getTotalEarnedPoints()) > 0;
    }

    /**
     * True if points are being earned or spent on this cart (not exclusively).
     * @return bool
     */
