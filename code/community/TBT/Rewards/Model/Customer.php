...
class TBT_Rewards_Model_Customer extends Mage_Customer_Model_Customer
{
    ...
    public function canAffordFromPointsHash($points_array) {
        ...
        foreach ( $points_array as $temp_transfer ) {
            ...
            $points_amount = $temp_transfer [TBT_Rewards_Model_Salesrule_Rule::POINTS_AMT] * $temp_transfer [TBT_Rewards_Model_Salesrule_Rule::POINTS_APPLICABLE_QTY];
            $currency_id = $temp_transfer [TBT_Rewards_Model_Salesrule_Rule::POINTS_CURRENCY_ID];
