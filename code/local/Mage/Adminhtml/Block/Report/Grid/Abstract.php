...
class Mage_Adminhtml_Block_Report_Grid_Abstract extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $resourceCollection = Mage::getResourceModel($this->getResourceCollectionName())
            ...
            ->setDateRange($filterData->getData('from', null), $filterData->getData('to', null), $filterData->getData('start_time', null), $filterData->getData('end_time', null))
        ...
        if ($filterData->getData('show_empty_rows', false)) {
            Mage::helper('reports')->prepareIntervalsCollection(
                $this->getCollection(),
                $filterData->getData('from', null) . ' ' . $filterData->getData('start_time', null),
                $filterData->getData('to', null) . ' ' . $filterData->getData('end_time', null),
