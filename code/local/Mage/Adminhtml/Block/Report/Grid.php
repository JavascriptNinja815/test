    ...
    protected function _prepareCollection()
    {
        ...
        if ($this->getFilter('report_from') && $this->getFilter('report_to')) {
            ...
            try {
                ...
                $collection->setInterval($from, $to, $this->getFilter('report_start_time'), $this->getFilter('report_end_time'));
            }
            catch (Exception $e) {
    ...
    public function getFilter($name)
    {
        if (isset($this->_filters[$name])) {
            ...
            return ($this->getRequest()->getParam($name))
                    ?((is_array($this->getRequest()->getParam($name)))?
                    	$this->getRequest()->getParam($name):htmlspecialchars($this->getRequest()->getParam($name))):'';
        }
    }
