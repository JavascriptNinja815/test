...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('reel_id', array(
            'header' => Mage::helper('sales')->__('Reel ID(s)'),
            'width' => '100px',
            'renderer' => new Image3D_Sales_Block_Renderer_Grid(),
        ));
        ...
        $this->addColumn('order_source', array(
            ...
            'renderer'  => 'chimage3d/adminhtml_report_sales_order_item_grid_renderer_source',
    ...
    {
        $this->getCollection()->reel_filter = isset($data['reel_id']) ? $data['reel_id'] : null;
