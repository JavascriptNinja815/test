...
class Collinsharper_Image3d_Adminhtml_Report_Sales_OrderController extends Mage_Adminhtml_Controller_Action
{
    protected $_gridContainerBlockName = 'chimage3d/adminhtml_report_sales_order';
    protected $_title = 'Orders';
    protected $_exportFileName = 'orders';
