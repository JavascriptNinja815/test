...
class Collinsharper_Image3d_Adminhtml_Report_Sales_Order_ItemController extends Mage_Adminhtml_Controller_Action
{
    protected $_gridContainerBlockName = 'chimage3d/adminhtml_report_sales_order_item';
    protected $_title = 'Ordered Items';
    protected $_exportFileName = 'ordered-items';
